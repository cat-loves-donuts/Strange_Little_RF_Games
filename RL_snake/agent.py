...
class Agent:
    def __init__(self):
        self.n_games = 0
        self.epsilon = 0 # used for random
        self.gama = 0.9 # discount rate in belleman equation
    ...
    def remember(self, state, action, reward, next_state, done):
        self.memory.append((state, action, reward, next_state, done))  # popleft if MAX_MEMEORY reached
...
def train():
    ...
    while True:
        ...
        if done:
            # train the long memory, experience replay, train again on all moves
